    ...
    children: [
      {
        ...
        target: '_self',
        path: '/exp9/hurwicz',
        component: '@/pages/exp9/Exp9_Hurwicz/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      },
      {
        ...
        target: '_self',
        path: '/exp9/laplace',
        component: '@/pages/exp9/Exp9_LAPLACE/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      },
      {
        ...
        target: '_self',
        path: '/exp9/maxmax',
        component: '@/pages/exp9/Exp9_MAXMAX/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      },
      {
        ...
        target: '_self',
        path: '/exp9/maxmin',
        component: '@/pages/exp9/Exp9_MAXMIN/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      },
      {
        ...
        target: '_self',
        path: '/exp9/regret',
        component: '@/pages/exp9/Exp9_REGRET/index.vue',
        renderMenu: true,
        permission: null,
        cacheable: true,
      },
