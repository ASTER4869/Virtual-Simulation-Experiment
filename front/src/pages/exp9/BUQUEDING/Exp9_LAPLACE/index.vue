<template>
    ...
    <h2>一、实验目的</h2>
    <p class="recontent">
        本实验旨在使用拉普拉斯法评估软件项目/产品开发中的不确定性，并探讨不同因素对于不确定性的影响。 本实验为课内设计性实验项目，实验学时 1 学时，完成实验报告 1 学时。
    </p>
    <h2>二、实验内容</h2>
    <p class="recontent">
      使用拉普拉斯法，探究不同估计方法下的方法选择。具体实验步骤如下：
    </p>
    ...
    <br />
    <h2>三、实验原理</h2>
    <h3 class="subtitle-content">1.拉普拉斯法</h3>
    <p class="content">
    ...
    <a-table bordered :data-source="dataSource" :columns="columns" :pagination="false">
        <template #bodyCell="{ column, text, record }">
            <template
                v-if="['plan', 'cost1', 'cost2', 'cost3', 'cost4', ].includes(column.dataIndex)">
                <div>
